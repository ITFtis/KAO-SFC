...
(function ($) {
    ...
    var pluginclass = function (element, e) {
        ...
        this.sewerInfo = {
            title: '下水道監測站', total: '0',
            legends: [app.siteRoot + 'images/pin/下水道_滿管.png', app.siteRoot + 'images/pin/下水道_一級.png', app.siteRoot + 'images/pin/下水道_二級.png'],
            snames: ['滿管','一級', '二級'],
            counts: ['0', '0', '0']
        }
    };
    pluginclass.prototype = {
        ...
        setSewerData: function (ds) {
            var t = 0,c0=0, c1 = 0, c2 = 0, c3 = 0;
            if (ds) {
                $.each(ds, function () {
                    if (this.Status) {
                        if (this.Status == "滿管")
                            c0++;
                        else if (this.Status == $.BasePinCtrl.pinIcons.water.warnLevel1.name)
                            c1++;
                        else if (this.Status == $.BasePinCtrl.pinIcons.water.warnLevel2.name)
                            c2++;
                        //else if (this.Status == $.BasePinCtrl.pinIcons.water.warnLevel3.name)
            ...
            this._setSatInfo(this.$_s_sta_c, $.extend(this.sewerInfo, { total: t, counts: [c0,c1, c2] }));
        }
    }
